---
title: "What Free Societies Must Know About the AI They Built Being Used Against Them"
date: 2026-04-07 15:41:00 -0400
...
The [EU DisinfoLab December 2025 report](https://www.disinfo.eu/disinfo-update-16-12-2025-2-2-2-2-2-2) documents how state-backed influence operations are increasingly integrated with broader hybrid warfare strategies — information operations synchronized with cyber operations, economic coercion, and military signaling. Agentic AI enables tighter coordination across these domains than was previously possible.
...
* [Foreign disinformation enters its AI era — just as U.S. pulls back resources to fight it](https://www.axios.com/2025/08/22/ai-disinformation-china-golaxy-vanderbilt) — Axios (August 2025). Documents China's GoLaxy synthetic persona network using DeepSeek's open-source model.
* [How cognitive manipulation and AI will shape disinformation in 2026](https://www.weforum.org/stories/2026/03/how-cognitive-manipulation-and-ai-will-shape-disinformation-in-2026/) — World Economic Forum (March 2026). Analysis of deepfake threshold crossing and AI-enabled cognitive manipulation.
* [AI Disinformation & Security in Asia/China/India/Russia Zone 2026](https://www.globenewswire.com/news-release/2025/10/10/3164960/28124/en/AI-Disinformation-Security-in-Asia-China-India-Russia-Zone-2026-Critical-Vulnerabilities-Emerging-Threat-Vectors-and-Strategic-Implications.html) — GlobeNewswire (October 2025). Assessment of adversary AI capabilities and financial market targeting.
* [EU DisinfoLab Disinfo Update December 2025](https://www.disinfo.eu/disinfo-update-16-12-2025-2-2-2-2-2-2) — EU DisinfoLab (December 2025). Documents state-backed influence operations integrated with hybrid warfare strategies.
* [Technological Approach to Mind Everywhere (TAME)](https://www.frontiersin.org/journals/systems-neuroscience/articles/10.3389/fnsys.2022.768201/full) — Levin et al., Frontiers in Systems Neuroscience (2022). Scientific framework for understanding multi-scale, distributed AI cognition — the architecture adversaries are exploiting.
