...
* [Artificial General Intelligence in 2026](https://www.timetrex.com/blog/artificial-general-intelligence-in-2026) — TimeTrex (2026). Prediction market analysis showing 10% probability of pure AGI by 2026.
* [AGI 2026 — How Close Are We?](https://www.singularitymoments.com/agi-2026/) — Singularity Moments. Covers Amodei's revised AGI timeline and Anthropic's positioning.
* [AGI Approaches: 2026 May Be the Turning Point](https://www.tradingkey.com/analysis/stocks/us-stocks/261488486-agi-2026-mark-turning-artificial-intelligence-musk-warns-white-collar-workers-tradingkey) — TradingKey (January 2026). Musk's AGI prediction and workforce implications.
* [AGI/Singularity: 9,800 Predictions Analyzed](https://aimultiple.com/artificial-general-intelligence-singularity-timing) — AI Multiple (February 2026). Meta-analysis of AGI timeline predictions.
* [AGI's Last Bottlenecks](https://ai-frontiers.org/articles/agis-last-bottlenecks) — AI Frontiers (October 2025). Framework arguing we are halfway to AGI with remaining work primarily engineering.
* [Technological Approach to Mind Everywhere (TAME)](https://www.frontiersin.org/journals/systems-neuroscience/articles/10.3389/fnsys.2022.768201/full) — Levin et al., Frontiers in Systems Neuroscience (2022). The scientific framework for substrate-agnostic, multi-scale cognition.
* [OpenClaw](https://en.wikipedia.org/wiki/OpenClaw) — Wikipedia. Overview of the open-source multi-agent orchestration platform.
