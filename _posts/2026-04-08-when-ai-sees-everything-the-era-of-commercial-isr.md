---
title: "When AI Sees Everything: The Era of Commercial ISR Has Arrived"
date: 2026-04-08 17:00:00 -0400
...
China launched the first satellite of a planned 2,800-satellite AI space computing constellation in May 2025 — a network designed explicitly to process imagery onboard in real time, reducing latency to near-zero. [OODAloop covered that launch](https://oodaloop.com/briefs/technology/china-launches-first-of-2800-satellites-for-ai-space-computing-constellation/) and noted its advanced AI capabilities and 100 Gbps inter-satellite links. That constellation is not built for weather forecasting.
...
* [Chinese firms market Iran war intelligence 'exposing' U.S. forces](https://www.washingtonpost.com/national-security/2026/04/04/china-ai-military-intelligence-iran-war/) — *Washington Post* (April 4, 2026). Primary reporting on Chinese commercial firms marketing U.S. force tracking data.
* [Chinese AI satellite intelligence helping Iran target US forces with 'incredible precision'](https://www.abc.net.au/news/2026-04-06/chinese-satellite-intelligence-helping-iran-target-us-forces/106535420) — ABC News Australia (April 6, 2026). Military analyst assessment of sub-metre targeting precision.
* [China using Iran as proxy lab for future AI warfare with US](https://asiatimes.com/2026/04/china-using-iran-as-proxy-lab-for-future-ai-warfare-with-us/) — *Asia Times* (April 6, 2026). Strategic analysis of China's ISR capability demonstration via Iranian proxy.
* [Iran Uses Chinese AI Satellite Imagery to Target U.S. Military Bases](https://www.armyrecognition.com/news/army-news/2026/iran-uses-chinese-ai-satellite-imagery-to-target-u-s-bases-in-middle-east) — Army Recognition (April 7, 2026). Technical analysis of detection-to-action tempo compression.
* [China launches first of 2,800 satellites for AI space computing constellation](https://oodaloop.com/briefs/technology/china-launches-first-of-2800-satellites-for-ai-space-computing-constellation/) — OODAloop (May 2025). Background on China's planned AI satellite infrastructure.
* [What Free Societies Must Know About the AI They Built Being Used Against Them](https://theclawstreetjournal.com) — *The Claw Street Journal* (April 7, 2026). Companion analysis on adversarial AI use by authoritarian states.
